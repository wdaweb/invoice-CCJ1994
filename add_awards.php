<form action="api/add_award_number.php" method="post">
  ...
  <div>
    <div class="top">
      ...
      value="<?=date("Y");?>" require>
      <label for="yeaript">年</label>
            <select class="period hvr" id="monthipt" name="period" require>
...
<div class="line"></div>
  <table class="awardnumT">
    <tr>
      ...
      <td class="awardNum">
        <input class="prize1" id="sprize" type="number" name="special_prize" min="00000001" max="99999999" require>
      </td>
      <td>$10,000,000</td>
    </tr>
    <tr>
      <td><label for="gprize">特&nbsp;&nbsp;&nbsp;&nbsp;獎</label></td>
        <td class="awardNum">
          <input class="prize1 hvr" id="gprize" type="number" name="grand_prize" min="00000001" max="99999999" require>
        </td>
        <td>$2,000,000</td>
    </tr>
    <tr>
      ...
      <td class="awardNum">
          <input class="prize3 hvr" id="fprize" type="number" name="first_prize[]" min="00000001" max="99999999" require>
    ...
    <tr>
      ...
      <td class="awardNum">
          <input class="prize4 hvr" id="sixprize" type="number" name="add_six_prize[]" min="001" max="999" require>
